pro m3_photom_full_correction_from_iof_engine, event, params=params, rdn_file=rdn_file, obs_file=obs_file, $
...
if n_elements(params) gt 0 then begin
  iof_file=params.rdn_file  ;structure tag named wrong but it contains iof file
...
;
if n_elements(iof_file) eq 0 then message, 'Must supply an I/F file.'
